...
export const DEFAULT_MODELS = {
  ...
  "gpt-5.5-fast": gpt55Model("GPT-5.5 Fast"),
  "gpt-5.5-codex": gpt55Model("GPT-5.5", "gpt-5.5"),
  "gpt-5.5-codex-fast": gpt55Model("GPT-5.5 Fast", "gpt-5.5-fast"),
}
...
function registerGpt55Models(catalog, entry) {
  ...
  catalog["gpt-5.5-fast"] =
    catalog["gpt-5.5-fast"] ?? createCatalogModel("gpt-5.5-fast", entry, "gpt-5.5-fast", "GPT-5.5 Fast")
  ...
  catalog["gpt-5.5-codex-fast"] =
    catalog["gpt-5.5-codex-fast"] ??
    createCatalogModel("gpt-5.5-codex-fast", entry, "gpt-5.5-fast", "GPT-5.5 Fast")
}
